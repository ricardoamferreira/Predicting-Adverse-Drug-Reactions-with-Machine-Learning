...
best_SVC_params_by_label = {'Blood and lymphatic system disorders': {'svc__C': 10,
                                                                     'svc__gamma': 0.01,
                                                                     'svc__kernel': 'rbf'},
...
best_xgb_params_by_label = {'Blood and lymphatic system disorders': {'xgbclassifier__colsample_bytree': 0.6,
                            ...
                            'Cardiac disorders': {'xgbclassifier__colsample_bytree': 0.6,
                                                  'xgbclassifier__eta': 0.2,
                            ...
                            'Ear and labyrinth disorders': {'xgbclassifier__colsample_bytree': 0.8,
                            ...
                            'Neoplasms benign, malignant and unspecified (incl cysts and polyps)': {
                                ...
                                'xgbclassifier__min_child_weight': 1,
                                'xgbclassifier__subsample': 0.9},
                            'Nervous system disorders': {'xgbclassifier__colsample_bytree': 0.8,
                                                         'xgbclassifier__eta': 0.1,
                                                         'xgbclassifier__gamma': 0.4,
                                                         'xgbclassifier__max_depth': 7,
                            ...
                            'Pregnancy, puerperium and perinatal conditions': {'xgbclassifier__colsample_bytree': 0.8,
                                                                               ...
                                                                               'xgbclassifier__min_child_weight': 1,
                                                                               'xgbclassifier__subsample': 0.9},
                            'Psychiatric disorders': {'xgbclassifier__colsample_bytree': 0.8,
                                                      'xgbclassifier__eta': 0.2,
                                                      'xgbclassifier__gamma': 0,
                                                      'xgbclassifier__max_depth': 5,
                                                      'xgbclassifier__min_child_weight': 1,
                            ...
                            'Skin and subcutaneous tissue disorders': {'xgbclassifier__colsample_bytree': 0.7,
                                                                       ...
                                                                       'xgbclassifier__min_child_weight': 1,
                                                                       'xgbclassifier__subsample': 0.6},
                            'Surgical and medical procedures': {'xgbclassifier__colsample_bytree': 0.9,
                                                                'xgbclassifier__eta': 0.2,
                                                                'xgbclassifier__gamma': 0.1,
                                                                'xgbclassifier__max_depth': 7,
                                                                'xgbclassifier__min_child_weight': 3,
